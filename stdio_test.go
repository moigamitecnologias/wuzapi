...
// TestTrimMessageHistory_SQLite_KeepsNewest verifies that trimMessageHistory
// retains the most-recent messages and removes the oldest ones.
func TestTrimMessageHistory_SQLite_KeepsNewest(t *testing.T) {
	s := makeTestServer(t)
